...
contested: >-
  ...
  reforms struck the right balance remain disputed. The empirical question of how much valuable
  intelligence bulk surveillance actually produces has never been fully adjudicated in public.
  See: President's Review Group on Intelligence and Communications Technologies, _Liberty and
  Security in a Changing World_, 2013.
timeline_cards:
...
The full scope of what these authorities enabled wouldn't become publicly known until 2013, when Edward Snowden revealed the NSA's PRISM program and related surveillance activities. But the legal architecture enabling that surveillance was built here.

**Source:** Electronic Frontier Foundation documentation on PATRIOT Act provisions; and subsequent analysis by legal scholars.
