...
## Version B: Build Your Own Categories

This version is better if you want students to feel the construction of categories more directly.

### Activity

Give groups 20 mixed examples without categories. Ask them to:

1. Sort the examples into 3–5 categories.
2. Name each category.
3. Write a rule for what belongs in each category.
4. Identify edge cases.
5. Trade category rules with another group.
6. Try to classify new examples using the other group’s rules.
...
- categories are made
- category names shape interpretation
- rules are incomplete
- edge cases are everywhere
- different groups optimize for different values
- classification systems travel poorly across contexts

This is a very good setup for AI because datasets require labels, and labels often depend on contested human judgments.

### Example Prompt

> You are designing a system that will sort campus incident reports so they can be routed to the right office. Create categories for the reports below. Your categories will later be used to train an automated classifier.

**Example incident report cards:**

- “Student reports feeling unsafe after repeated unwanted messages.”
- “Resident assistant reports loud noise after midnight.”
- “Student says a professor made an offensive joke.”
- “Campus police report a person sleeping in a library stairwell.”
- “Student reports a panic attack during class.”
- “Faculty member reports suspected plagiarism.”
- “Student organization reports vandalized posters.”
- “Staff member reports a person entering a restricted area.”
- “Student reports being misgendered repeatedly.”
- “Dining worker reports a student taking food without paying.”

Possible categories could be “safety,” “conduct,” “mental health,” “academic integrity,” “bias incident,” “facilities,” etc. But many examples will cross categories.

### Ethical Payoff

This lab makes visible that classification systems often decide:

- who receives care
- who receives punishment
- who gets surveilled
- who is believed
- which institution responds
