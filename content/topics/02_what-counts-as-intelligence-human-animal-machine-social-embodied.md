...
This recognition pattern matters here because claims about machine intelligence are never just about a technical model. They also depend on cultural expectations, labor systems, institutional goals, commercial narratives, and public ideas about what minds and machines are supposed to do.

## BRAID / ELSI Connection

The BRAID case asks students to examine an emerging neuromorphic anomaly-detection system without treating it as a self-evidently “smart” device. Before asking how such a system works, we need to ask what kinds of sensing, adaptation, or response would count as intelligence in the first place, and who gets to make that judgment.
...
Assign the science of learning sawyer article.
